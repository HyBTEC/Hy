                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero__text">
                            <div class="label">New life</div>
                            <h2>Mushoku Tensei - Season 1</h2>
                            <p>When I reincarnated into another region and experienced a new life.....</p>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero__text">
                            ...
                            <h2>Mobile Suit Gundam - RX 78 Gundam</h2>
                            <p>Machines built by humans to fight against the forces ......</p>
                            <a href="#"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                            ...
                            <div class="product__item">
                                <a href="anime-details.html">
                                    <div class="product__item__pic set-bg" data-setbg="img/trending/trend-1.jpg">
                                        <div class="ep" style="text-align: right;">18 / 18</div>
                            ...
                            <div class="product__item">
                                <a href="anime-details.html">
                                    <div class="product__item__pic set-bg" data-setbg="img/trending/trend-4.jpg">
                                        <div class="ep">18 / 18</div>
                                        <div class="vip-badge">VIP</div> <!-- Add VIP badge here -->
                                        <div class="comment"><i class="fa fa-comments"></i> 11</div>
                                        <div class="view"><i class="fa fa-eye"></i> 9141</div>
                                    </div>
                                    <div class="product__item__text">
                ...
                <div class="popular__product">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="btn__all">
                                <a href="anime-details.html" class="primary-btn">View All <span class="arrow_right"></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
